   ...
   const removeCartItemHandler= (id)=>{
    ...
    return (
        <Fragment>
            ...
            {cartItems.length === 0 ? <h2 className="mt-5">Su carrito de compras esta vacio</h2> : (
                <Fragment>
                    
                    <h2 className="mt-5">Productos en su Carrito: <b>{cartItems.reduce((acc, item)=>(acc+Number(item.quantity)),0)} items</b></h2>

...
router.route('/perfil').get(isAuthenticatedUser, getUserProfile)
router.route('/perfil/updatePassword').put(isAuthenticatedUser, updatePassword)
router.route('/perfil/updateProfile').put(isAuthenticatedUser, updateProfile)
